Kino::Application.routes.draw do
  ...
  match 'public/delete_ticket' => 'public#delete_ticket'
    ...
    match 'zpiheroku2011.heroku.com/public/payment_ok' => 'public#payment_ok', :as => 'payment_ok'
    match 'zpiheroku2011.heroku.com/public/payment_error' => 'public#payment_error', :as => 'payment_error'
