...
users = User.create!([{:login => 'damian', :hashed_password => 'wtw', :email => 'projekt_iz@o2.pl', :phone => 123456789, :first_name => 'Damian', :last_name => 'Jaszczurowski'},
                      {:login => 'andrzej', :hashed_password => 'wtw', :email => 'dj.serwisy@gmail.com', :phone => 123456789, :first_name => 'Andrzej', :last_name => 'Kordian'}])                                  