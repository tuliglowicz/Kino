...
ticket_sort_types = TicketSortPrice.create([{:cinema_id => cinemas.first, :seance_types => seance_types.first, :ticket_type_id => ticket_types.first, :discount_sort_id => discounts_sorts.first, :price => 19},
                                            {:cinema_id => cinemas.first, :seance_types => seance_types.first, :ticket_type_id => ticket_types[1], :discount_sort_id => discounts_sorts.first, :price => 16},
                                            {:cinema_id => cinemas.first, :seance_types => seance_types.first, :ticket_type_id => ticket_types[2], :discount_sort_id => discounts_sorts.first, :price => 14}])
