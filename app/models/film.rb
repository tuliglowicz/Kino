...
class Film < ActiveRecord::Base
	...
	validates_length_of :title, :maximum => 100, :message => 'Pole title musi być krótsze niż 100 znaków'
	validates_length_of :director, :maximum => 50, :message => 'Pole director musi być krótsze niż 50 znaków'
	validates_length_of :trailer, :maximum => 75, :message => 'Pole trailer musi być krótsze niż 75 znaków'
	validates_length_of :poster, :maximum => 50, :message => 'Pole poster musi być krótsze niż 50 znaków'
