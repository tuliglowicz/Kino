...
class Seat < ActiveRecord::Base
	...
	validates_presence_of :room_id, :message => ' Pole Sala nie może być puste.'
	...
	validates_numericality_of :collumn, :room_id, :only_integer => true, :message => 'Pole Kolumna musi być liczbą całkowitą!'
